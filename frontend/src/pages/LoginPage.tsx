// this file defines the login page, with form validation, error handling, and redirect after login
    ...
    >
      ...
      >
        <TextField
          ...
          error={errors.email?.message}  // maps backend field errors to form fields
          {...register('email')}
        />
