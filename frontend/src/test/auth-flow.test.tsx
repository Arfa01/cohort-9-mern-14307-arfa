// this file has 9 frontend behavior tests
...
jest.mock('../api/auth.api', () => ({      // mock the api functions so that we can control their behavior in tests
...
describe('frontend authentication flow', () => {  // verify restoration of session, redirection, validation, login, register, dup email, logout, retry session network failure
  beforeEach(() => {
    jest.resetAllMocks()
