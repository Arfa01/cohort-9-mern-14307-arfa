// this is toplevel sceen controller. chooses the correct route based on auth state (login page or dashboard) 
...
function App() {
  ...
  if (state.status === 'error') {     // backend unavialble retry screen. 
    return (
      <main className="grid min-h-screen place-items-center bg-stone-50 px-5">
  ...
  return (     //unknown urls are redirected to / (dashboard)
    <Routes>
